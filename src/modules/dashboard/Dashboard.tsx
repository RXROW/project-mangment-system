...
const Dashboard = () => {
  ...
  const taskCards = [
    { title: "In Progress", count: progress, image: img1, bgColor: "rgba(229, 230, 244, 1)" },
    { title: "To Do", count: tasksToDo, image: img2, bgColor: "rgba(244, 244, 229, 1)" },
    { title: "Done", count: taskDone, image: img3, bgColor: "rgba(244, 229, 237, 1)" },
  ];

  const userCards = [
    { title: "Active", count: active, image: img1, bgColor: "rgba(229, 230, 244, 1)" },
    { title: "Inactive", count: inActive, image: img2, bgColor: "rgba(244, 244, 229, 1)" },
  ];
          ...
          <div className="col-12 col-md-6 bg-light p-4 rounded-3 shadow-sm">
            ...
            <div className="d-flex justify-content-center">
              <ChartComponent
                ...
                two={tasksToDo}
                three={taskDone}
                colorOne="rgba(54, 162, 235, 0.5)"
                colorTwo="rgba(255, 205, 86, 0.5)"
                colorThree="rgba(244, 229, 237, 0.7)"
              />
            </div>
          </div>
